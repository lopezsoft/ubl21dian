...
### Changed
- **Client**: Cuando `$template->To` llega vacío, en lugar de lanzar una excepción se asigna automáticamente el endpoint de producción de la DIAN: `https://vpfe.dian.gov.co/WcfDianCustomerServices.svc?wsdl`.

## [3.6.7] - 2026-02-24

### Fixed
- **Client**: Agregada validación explícita de `$template->To` en el constructor. Cuando el endpoint llega vacío o nulo, ahora lanza una excepción descriptiva en lugar de fallar con `cURL errno 3` sin contexto.
